...
$layout->blocks["top"][] = "search";$page_layouts["pelatihan_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "id_pelatihan";
						}
...
$viewControls = new ViewControlsContainer(new ProjectSettings("karyawan", PAGE_LIST), PAGE_LIST);
