...
function checkTableName($shortTName, $type=false)
{
	...
	if ("absensi" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("karyawan" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("login" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pelatihan" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("penghasilan" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("penilaian" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
...
{
	$arr = array();
	$strPerm = GetUserPermissions("absensi");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="absensi";
	}
	$strPerm = GetUserPermissions("karyawan");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="karyawan";
	}
	...
	$strPerm = GetUserPermissions("pelatihan");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pelatihan";
	}
	...
	$strPerm = GetUserPermissions("penilaian");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="penilaian";
	}
...
function GetUserPermissionsStatic($table="")
{
	...
	if($table=="absensi" && $sUserGroup=="karyawan")
	{
			return "S";
	}
	if($table=="absensi" && $sUserGroup=="admin")
	{
			return "AEDSPI";
	}
//	default permissions	
	...
	if($table=="karyawan" && $sUserGroup=="karyawan")
	{
			return "S";
	}
	if($table=="karyawan" && $sUserGroup=="admin")
	{
			return "AEDSPI";
	}
//	default permissions	
	...
	if($table=="login" && $sUserGroup=="karyawan")
	{
			return "S";
	}
	if($table=="login" && $sUserGroup=="admin")
	{
			return "AEDSPI";
	}
//	default permissions	
	...
	if($table=="pelatihan" && $sUserGroup=="karyawan")
	{
			return "S";
	}
	if($table=="pelatihan" && $sUserGroup=="admin")
	{
			return "AEDSPI";
	}
//	default permissions	
	...
	if($table=="penghasilan" && $sUserGroup=="karyawan")
	{
			return "S";
	}
	if($table=="penghasilan" && $sUserGroup=="admin")
	{
			return "AEDSPI";
	}
//	default permissions	
	...
	if($table=="penilaian" && $sUserGroup=="karyawan")
	{
			return "S";
	}
	if($table=="penilaian" && $sUserGroup=="admin")
	{
			return "AEDSPI";
	}
//	default permissions	
	...
	if($table=="users" && $sUserGroup=="karyawan")
	{
			return "S";
	}
