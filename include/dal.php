...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"absensi","varname"=>"absensi");
	  $this->lstTables[]=array("name"=>"karyawan","varname"=>"karyawan");
	  $this->lstTables[]=array("name"=>"login","varname"=>"login");
	  $this->lstTables[]=array("name"=>"pelatihan","varname"=>"pelatihan");
	  $this->lstTables[]=array("name"=>"penghasilan","varname"=>"penghasilan");
	  $this->lstTables[]=array("name"=>"penilaian","varname"=>"penilaian");
