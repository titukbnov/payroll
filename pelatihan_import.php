...
$strOriginalTableName="`pelatihan`";
if(!isLogged())
{ 
...
// keys array
$keys[]=AddFieldWrappers("id_pelatihan");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("id_pelatihan",$fields))
		$autoinc=true;
...
$layout = new TLayout("import","ExtravaganzaBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "import";$page_layouts["pelatihan_import"] = $layout;
...
$xt->display("pelatihan_import.htm");
