...
// keys array
$keys[]=AddFieldWrappers("id_penilaian");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("id_penilaian",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["penilaian_import"] = $layout;
...
$xt->display("penilaian_import.htm");
