...
$layout->blocks["top"][] = "pdf";$page_layouts["login_print"] = $layout;
...
//	process selection
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["id_login"]=refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[]=$keys;
		}
	}
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "user_level";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("user_level");
$fieldsArr[] = $arr;
$arr = array();
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "last_update";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("last_update");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "created";
...
//	id_login - 
			$record["id_login_value"] = $pageObject->showDBValue("id_login", $data, $keylink);
			$record["id_login_class"] = $pageObject->fieldClass("id_login");
//	username - 
...
//	user_level - 
			$record["user_level_value"] = $pageObject->showDBValue("user_level", $data, $keylink);
			$record["user_level_class"] = $pageObject->fieldClass("user_level");
//	last_login - Short Date
			$record["last_login_value"] = $pageObject->showDBValue("last_login", $data, $keylink);
			$record["last_login_class"] = $pageObject->fieldClass("last_login");
//	last_update - Short Date
			$record["last_update_value"] = $pageObject->showDBValue("last_update", $data, $keylink);
			$record["last_update_class"] = $pageObject->fieldClass("last_update");
//	created - Short Date
...
$xt->assign("id_login_fieldheadercolumn",true);
$xt->assign("id_login_fieldheader",true);
$xt->assign("id_login_fieldcolumn",true);
$xt->assign("id_login_fieldfootercolumn",true);
...
$xt->assign("user_level_fieldheadercolumn",true);
$xt->assign("user_level_fieldheader",true);
$xt->assign("user_level_fieldcolumn",true);
$xt->assign("user_level_fieldfootercolumn",true);
$xt->assign("last_login_fieldheadercolumn",true);
$xt->assign("last_login_fieldheader",true);
$xt->assign("last_login_fieldcolumn",true);
$xt->assign("last_login_fieldfootercolumn",true);
$xt->assign("last_update_fieldheadercolumn",true);
$xt->assign("last_update_fieldheader",true);
$xt->assign("last_update_fieldcolumn",true);
$xt->assign("last_update_fieldfootercolumn",true);
