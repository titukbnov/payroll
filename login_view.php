...
$layout->blocks["top"][] = "details";$page_layouts["login_view"] = $layout;
...
//user_level - 
	...
	if($mainTableOwnerID=="user_level")
		$ownerIdValue=$value;
	$xt->assign("user_level_value",$value);
...
//last_update - Short Date
	...
	if($mainTableOwnerID=="last_update")
		$ownerIdValue=$value;
	$xt->assign("last_update_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='login_edit.php?".$editlink."'\"");
