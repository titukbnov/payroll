...
// keys array
$keys[]=AddFieldWrappers("id_penghasilan");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("id_penghasilan",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["penghasilan_import"] = $layout;
...
$xt->display("penghasilan_import.htm");
