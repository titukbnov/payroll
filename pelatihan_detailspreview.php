...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["pelatihan_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	id_pelatihan - 
		    ...
		    $value = $viewContainer->showDBValue("id_pelatihan", $data, $keylink);
			$row["id_pelatihan_value"] = $value;
	//	nip - 
			$viewContainer->recId = $recordsCounter;
	...
	//	tgl_pelatihan - Short Date
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("tgl_pelatihan", $data, $keylink);
			$row["tgl_pelatihan_value"] = $value;
	//	sk_pelatihan - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("sk_pelatihan", $data, $keylink);
			$row["sk_pelatihan_value"] = $value;
	//	topik_pelatihan - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("topik_pelatihan", $data, $keylink);
			$row["topik_pelatihan_value"] = $value;
	//	penyelenggara - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("penyelenggara", $data, $keylink);
			$row["penyelenggara_value"] = $value;
	//	hasil_pelatihan - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("hasil_pelatihan", $data, $keylink);
			$row["hasil_pelatihan_value"] = $value;
		$rowinfo[] = $row;
		$data = $cipherer->DecryptFetchedArray($rs);
	}
...
$xt->load_template("pelatihan_detailspreview.htm");
