...
include_once("include/absensi_settings.php");
include_once("include/pelatihan_settings.php");
include_once("include/penghasilan_settings.php");
include_once("include/penilaian_settings.php");
...
$layout = new TLayout("list2","ExtravaganzaBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "search";$page_layouts["karyawan_list"] = $layout;
